...
# =====================================================
# TRUEIMAGE MODEL TRAINING SCRIPT - EFFICIENTNET-B3
# =====================================================
...
MODEL_SAVE_PATH = MODEL_OUTPUT_DIR / "trueimage_efficientnet_b3.keras"
BEST_WEIGHTS_PATH = MODEL_OUTPUT_DIR / "trueimage_efficientnet_b3_best.weights.h5"
...
def build_model():
    ...
    model = tf.keras.Model(
        inputs,
        outputs,
        name="trueimage_efficientnet_b3_detector"
    )
...
def train_model():
    print("\nTRUEIMAGE EfficientNet-B3 Training Started")
    print("------------------------------------------")
